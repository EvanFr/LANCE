...
conda env create -f ./artifact/LANCE/environment.yaml
...
conda env create -f ./artifact/LANCE_sota_LLMs/transformers_env.yml
...
conda env create -f ./artifact/LANCE_sota_LLMs/Gemini/environment.yaml
...
conda env create -f ./artifact/IoCMiner/environment.yaml
